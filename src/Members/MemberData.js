...
export  const finalYear = [
    ...
    {
        "url": require("../SAEMembers/Siddharth Khandelwal.jpg"),
    ...
    {
        "url": require("../SAEMembers/Prince Raj.jpg"),
        "name": "Prince Raj",
        "position": "Joint Secretary",
    ...
    {
        "url": require("../SAEMembers/Dipesh Banerjee.jpg"),
    ...
    {
        "url": require('../SAEMembers/Gautam.png'),
        "name": "Gautam Kesari",
        "position": "Convener",
    ...
    {
        "url": require("../SAEMembers/Sachin Patel.jpg"),
        "name": "Sachin Patel",
    ...
    {
        "url": require("../SAEMembers/Biswajit.png"),
        "name": "Biswajit",
        "position": "Technical Head",
    ...
    {
        "url": require("../SAEMembers/Aksha.png"),
        "name": "Aksha",
    ...
    {
        "url": require("../SAEMembers/Ritu Rani.png"),
        "name": "Ritu Rani",
        "position": "Head ATH",
